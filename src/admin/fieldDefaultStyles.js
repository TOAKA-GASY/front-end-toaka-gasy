...
const FIELD_STYLES = {
  ...
  'ourStory.regionsEyebrow': { font: 'cinzel', color: '#1f0e06' },
  'ourStory.regionsTitleLine1': { font: 'cinzel', color: '#1f0e06' },
  'ourStory.regionsTitleLine2': { font: 'cinzel', color: '#1f0e06' },
  'ourStory.regionsBody': { font: 'simonetta', color: '#1f0e06' },
  'ourStory.regionWestLabel': { font: 'cinzel', color: '#a86b33' },
  'ourStory.regionWestBody': { font: 'simonetta', color: '#69431D' },
  'ourStory.regionNorthLabel': { font: 'cinzel', color: '#a86b33' },
  'ourStory.regionNorthBody': { font: 'simonetta', color: '#69431D' },
  'ourStory.regionHighlandsLabel': { font: 'cinzel', color: '#a86b33' },
  'ourStory.regionHighlandsBody': { font: 'simonetta', color: '#69431D' },
  'ourStory.regionEastLabel': { font: 'cinzel', color: '#a86b33' },
  'ourStory.regionEastBody': { font: 'simonetta', color: '#69431D' },
  'ourStory.regionSouthLabel': { font: 'cinzel', color: '#a86b33' },
  'ourStory.regionSouthBody': { font: 'simonetta', color: '#69431D' },
